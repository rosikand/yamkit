    ...
    *,
    ...
    def validate_trace(body: InferenceBody) -> None:
        ...
        if body.capture_trace and (
                ...
                or body.task != TRACE_TASK or body.duration not in (5, 10, 20, 30, 45, 60)
            ...
            raise ValueError("Debug capture requires the task 'put the red cube into the black container', 5, 10, 20, 30, 45 or 60 seconds, both named followers, and the unchanged raw-RGB HTTP graph settings")
