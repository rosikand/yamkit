    ...
    el.innerHTML = `
      ...
      <div class="sect"><div class="sect-head">Policy deployment</div><div class="panel pad">
        ...
        <div id="inf-attach-controls">
          ...
          <label class="check"><input type="checkbox" id="inf-trace" /> Save 30 fps video and joint traces (put the red cube into the black container, 5, 10, 20, 30, 45 or 60 seconds).</label>
          ...
          <div class="hint">Upload saves all debug data after the arms are released and video export finishes. Local originals are kept. Requires 5, 10, 20, 30, 45 or 60 second capture.</div>
